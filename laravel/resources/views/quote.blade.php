      ...
      <div class="row">
        ...
        foreach ($quotes as $quote) {
          ...
          <div class="entry-meta">
            <ul>
              <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="{{ url(/single) }}">'.$quote->owner.' - <i>'.$quote->desc.'</i></a></li>
              <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{ url(/single) }}"><time datetime="'.$quote->time.'">'.$quote->time.'</time></a></li>
            </ul>
          </div>

          <div class="entry-content">
            <p>
                <blockquote style="font-family: "Georgia", serif; font-size: 16px; font-style: italic; background-color: #f0f0f0; padding: 10px;">
                "'.$quote->quote.'"
               </blockquote>
            </p>
          </div>
